...
export default function Opportunities3DCarousel({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1280px] my-1 py-1 flex items-center justify-center perspective-1200">
        <div
          className="relative w-full h-[470px] sm:h-[495px] md:h-[515px] flex items-center justify-center preserve-3d cursor-grab active:cursor-grabbing"
          style={{ touchAction: "pan-y" }}
        ...
        >
          {mandates.map((item, index) => {
            ...
            if (offset === 0) {
              ...
              transformStr = `translateX(56%) translateZ(-90px) rotateY(-20deg) scale(0.85)`;
              zIndex = 25;
              opacity = 0.85;
            } else if (offset === -1) {
              ...
              transformStr = `translateX(${dir * 88}%) translateZ(-260px) rotateY(${dir * -32}deg) scale(0.68)`;
              zIndex = 10;
              opacity = 0.5;
            }
            ...
            return (
              <div
                ...
                className={`absolute w-[92%] max-w-[880px] h-full rounded-[24px] overflow-hidden transition-all duration-500 ease-out preserve-3d shadow-2xl ${
                  isActive
                ...
                style={{
                  ...
                  boxShadow: isActive
                    ? "0 30px 70px -15px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255, 255, 255, 0.15)"
              ...
              >
                ...
                <div className="w-full h-[calc(100%-6px)] p-3.5 sm:p-5 flex flex-col justify-between items-start overflow-hidden text-white">
                  {/* Top Card Flyer Banner */}
                  <div className="w-full flex justify-between items-start z-10 shrink-0 pb-2.5 border-b border-white/15">
                    <div className="space-y-0.5">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="px-2.5 py-0.5 rounded-full bg-[#EB6A4C] text-white text-[10px] font-black tracking-wider uppercase shadow-sm">
                          {item.type}
                        </span>
                        <span className="px-2.5 py-0.5 rounded-full bg-white/15 text-white text-[10px] font-extrabold tracking-wider border border-white/20">
                          {item.code}
                        </span>
                      </div>
                    ...
                    {isActive && (
                      <div className="flex items-center gap-1.5 shrink-0 ml-2">
                        <button
                          ...
                          className="w-7 h-7 rounded-full bg-white/15 hover:bg-white/30 backdrop-blur-md border border-white/20 flex items-center justify-center transition-all active:scale-95 text-white"
                        >
                  ...
                  <div className="w-full my-1.5 flex flex-wrap gap-1.5 shrink-0 z-10">
                    {item.badges.map((badge, bIdx) => (
                      <span
                        key={bIdx}
                        className="px-2 py-0.5 rounded-md bg-black/40 backdrop-blur-md border border-white/10 text-[10px] font-semibold text-slate-100 flex items-center gap-1.5"
                      >
                  ...
                  {/* ========================================================= */}
                  <div className="w-full flex-1 overflow-y-auto pr-1 my-1 space-y-2.5 text-xs text-slate-200 scrollbar-thin scrollbar-thumb-white/25 scrollbar-track-transparent z-10">
                    
                    {/* Row 1: Sections 1, 2, 3 (Acquirer Snapshot, Strategic Rationale, Target Criteria) */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5">
                      {/* 1. Acquirer Snapshot */}
                      <div className="p-2.5 rounded-xl bg-black/40 border border-white/12 space-y-1.5">
                        <div className="flex items-center gap-1.5 text-[#38BDF8] font-bold text-[10px] font-display border-b border-white/10 pb-1">
                          <span className="w-4 h-4 rounded-md bg-[#38BDF8]/20 flex items-center justify-center text-[9px]">
                            1
                          </span>
                      ...
                      <div className="p-2.5 rounded-xl bg-black/40 border border-white/12 space-y-1.5">
                        <div className="flex items-center gap-1.5 text-[#EB6A4C] font-bold text-[10px] font-display border-b border-white/10 pb-1">
                          <span className="w-4 h-4 rounded-md bg-[#EB6A4C]/20 flex items-center justify-center text-[9px]">
                            2
                          </span>
                      ...
                      {/* 3. Target Criteria */}
                      <div className="p-2.5 rounded-xl bg-black/40 border border-white/12 space-y-1.5">
                        <div className="flex items-center gap-1.5 text-teal-300 font-bold text-[10px] font-display border-b border-white/10 pb-1">
                          <span className="w-4 h-4 rounded-md bg-teal-300/20 flex items-center justify-center text-[9px]">
                            3
                          </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                      ...
                      <div className="p-2.5 rounded-xl bg-black/40 border border-white/12 space-y-1.5">
                        <div className="flex items-center gap-1.5 text-amber-300 font-bold text-[10px] font-display border-b border-white/10 pb-1">
                          <span className="w-4 h-4 rounded-md bg-amber-300/20 flex items-center justify-center text-[9px]">
                            4
                          </span>
                        ...
                        <div className="grid grid-cols-4 gap-1.5 text-center text-[10px]">
                          <div className="p-1.5 rounded-lg bg-white/10 border border-white/10">
                            <span className="text-[7.5px] text-slate-400 uppercase font-bold block">Revenue Range</span>
                            <span className="font-black text-white">{item.financialParameters.revenueRange}</span>
                          </div>
                          <div className="p-1.5 rounded-lg bg-white/10 border border-white/10">
                            <span className="text-[7.5px] text-slate-400 uppercase font-bold block">EBITDA Target</span>
                            <span className="font-black text-emerald-300">{item.financialParameters.ebitdaTarget}</span>
                          </div>
                          <div className="p-1.5 rounded-lg bg-white/10 border border-white/10">
                            <span className="text-[7.5px] text-slate-400 uppercase font-bold block">Headcount</span>
                            <span className="font-black text-white">{item.financialParameters.headcountRange}</span>
                          </div>
                          <div className="p-1.5 rounded-lg bg-white/10 border border-white/10">
                            <span className="text-[7.5px] text-slate-400 uppercase font-bold block">Max Client Conc.</span>
                      ...
                      {/* 5. Deal Structure */}
                      <div className="p-2.5 rounded-xl bg-black/40 border border-white/12 space-y-1.5">
                        <div className="flex items-center gap-1.5 text-purple-300 font-bold text-[10px] font-display border-b border-white/10 pb-1">
                          <span className="w-4 h-4 rounded-md bg-purple-300/20 flex items-center justify-center text-[9px]">
                            5
                          </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 text-[10px]">
                      ...
                      <div className="p-2.5 rounded-xl bg-black/40 border border-white/12 space-y-1">
                        <div className="flex items-center gap-1.5 text-emerald-400 font-bold text-[10px] font-display border-b border-white/10 pb-1">
                          <span className="w-4 h-4 rounded-md bg-emerald-400/20 flex items-center justify-center text-[9px]">
                            6
                          </span>
                      ...
                      <div className="p-2.5 rounded-xl bg-black/40 border border-white/12 space-y-1">
                        <div className="flex items-center gap-1.5 text-sky-300 font-bold text-[10px] font-display border-b border-white/10 pb-1">
                          <span className="w-4 h-4 rounded-md bg-sky-300/20 flex items-center justify-center text-[9px]">
                            7
                          </span>
                      ...
                      <div className="p-2.5 rounded-xl bg-black/40 border border-white/12 space-y-1.5">
                        <div>
                          <span className="text-emerald-400 font-bold text-[9.5px] uppercase flex items-center gap-1">
                            <CheckCircle2 className="w-3 h-3" />
                            <span>ACTIVELY PRIORITISED</span>
                          </span>
                          <p className="text-slate-200 mt-0.5 leading-snug">{item.activelyPrioritised.join("; ")}</p>
                        </div>
                        <div>
                          <span className="text-rose-400 font-bold text-[9.5px] uppercase flex items-center gap-1">
                            <XCircle className="w-3 h-3" />
                            <span>TO BE AVOIDED</span>
                          </span>
                          <p className="text-slate-300 mt-0.5 leading-snug">{item.toBeAvoided.join("; ")}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-full pt-2.5 border-t border-white/15 flex flex-col sm:flex-row justify-between items-center gap-2 shrink-0 z-10 text-xs">
                    <div className="flex items-center gap-2">
                      <div className="w-7 h-7 rounded-full bg-[#EB6A4C] text-white font-black flex items-center justify-center text-[11px] shadow-md">
                        RG
                      </div>
                      <div>
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-full bg-[#EB6A4C] hover:bg-[#d8583a] text-white font-black text-[11px] uppercase tracking-wider shadow-xl flex items-center gap-1.5 transition-all transform hover:scale-105"
                    >
