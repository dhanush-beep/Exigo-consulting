...
export default function FundraisingPage() {
  ...
  const servicesList = [
    {
      title: "Venture Capital & PE Advisory",
      description:
        "Strategic preparation and direct intro to tier-1 institutional VC and Private Equity funds.",
      icon: TrendingUp
    },
    {
      title: "Structured Debt & Mezzanine",
      description:
        "Non-dilutive financing structures tailored for high-growth enterprises and working capital.",
      icon: LineChart
    },
    {
      title: "Pitch Deck & Financial Modeling",
      description:
        "Build institutional-grade financial forecasts, unit economics, and investor-ready pitch decks.",
      icon: PieChart
    },
    {
      title: "Investor Roadshow Strategy",
      description:
        "Targeted investor mapping, roadshow management, and term-sheet negotiation support.",
      icon: DollarSign
    }
  ];

  const processSteps = [
    { number: "01", title: "Financial Model", icon: BarChart3 },
    { number: "02", title: "Valuation", icon: PieChart },
    { number: "03", title: "Pitch Prep", icon: Lightbulb },
    { number: "04", title: "Investor Outreach", icon: Network },
    { number: "05", title: "Term Sheet", icon: ShieldCheck },
    { number: "06", title: "Due Diligence", icon: UserCheck },
    { number: "07", title: "Capital Closing", icon: Award }
  ];
  ...
  const stats = [
    {
      icon: Trophy,
      value: "150+",
      label: "Investor & PE Network",
      sublabel: "Curated institutional partners"
    },
    {
      icon: Coins,
      value: "₹350Cr+",
      label: "Capital Raised",
      sublabel: "Across Series A to Debt rounds"
    },
    {
      icon: Users,
      value: "18+",
      label: "Years Experience",
      sublabel: "In corporate finance"
    },
    {
      icon: Target,
      value: "98%",
      label: "Client Satisfaction",
      sublabel: "Successful round execution"
    }
  ];
  ...
  const testimonials = [
    {
      quote:
        "Exigo positioned our narrative impeccably. We closed our Series A round within 4 months with top VCs.",
    ...
    {
      quote:
        "Their financial modeling and term sheet guidance saved us significant equity dilution.",
      author: "Priya Nair",
      role: "CFO, HealthTech Labs",
      avatar: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=200&q=80"
    },
    {
      quote:
        "World-class advisors who understand investor benchmarks inside out.",
      author: "Karan Mehta",
      role: "CEO, LogiScale India",
  ...
  const faqs = [
    {
      question: "How long does a fundraising round take?",
      answer:
        "A typical institutional round takes 3 to 6 months from pitch refinement to final capital disbursement."
    },
    {
      question: "What types of capital do you help raise?",
      answer:
        "We assist with Seed, Series A/B, Growth Private Equity, Venture Debt, Mezzanine, and Debt Financing."
    },
    {
      question: "Do you assist with pitch deck preparation?",
      answer:
        "Yes, we build institutional-grade 3-statement financial models, investor decks, and data room structures."
    },
    {
      question: "What is your success fee structure?",
      answer:
        "Our fee structure includes a mandate setup retainer along with a success fee upon successful capital closing."
    }
  ];
  ...
  return (
    <div className="bg-[#F8FAFC] min-h-screen text-[#1E293B]">
      {/* 1. HERO SECTION matching exact redesign template */}
        ...
        <Container className="w-full relative z-10 py-16 sm:py-20 lg:py-24">
          <div className="max-w-xl lg:max-w-xl flex flex-col items-start text-left">
            ...
            <p className="text-slate-300 text-base sm:text-xl font-normal leading-relaxed max-w-md">
              Helping businesses secure institutional<br className="hidden sm:inline" />
      ...
      <Container className="py-14 sm:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            {/* SECTION 1: OUR SERVICES / MANDATE FOCUS */}
            <div>
            ...
            {/* SECTION 2: OUR FUNDRAISING PROCESS */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <div className="md:col-span-7 flex flex-col items-start">
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 leading-relaxed mb-6">
                    Exigo Consulting provides specialized capital advisory services helping startups, mid-market enterprises, and corporate scaling ventures raise equity and debt capital from top global institutional investors.
                  </p>
                ...
                <div className="md:col-span-5 relative rounded-xl overflow-hidden">
                  ...
                  <div className="absolute inset-x-3 bottom-3 bg-[#0B343D]/95 text-white p-3.5 rounded-lg backdrop-blur-sm border border-white/10 shadow-lg">
                    <p className="text-[11px] font-medium leading-snug">
                      Our mission is to empower growth through structured capital strategies.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-[#0B2530] text-white py-10 px-6 sm:px-10 rounded-2xl shadow-xl mt-16 flex flex-col md:flex-row justify-between items-center gap-6 border border-white/10">
          <div className="flex flex-col gap-1 text-center md:text-left">
            <h3 className="text-xl sm:text-2xl font-bold text-white font-display">
              Ready to scale your capital round?
            </h3>
