...
import { Layers, CheckCircle2, ArrowRight, Shield } from "lucide-react";

export const metadata = constructMetadata({
  title: "Business Strategy & Consulting Practice",
  description: "Growth strategy, operational process optimization, restructuring, and GTM plans for mid-market scale."
});

export default function BusinessConsultingPage() {
  const service = services.find((s) => s.slug === "business-consulting")!;
    ...
    <div className="py-16 sm:py-24 bg-white min-h-screen relative">
      ...
      <Container className="relative z-10">
        ...
        <div className="text-xs sm:text-sm text-[#6C7A86] mb-8 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-[#1B2730] font-medium">Business Consulting</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16 items-center mb-20">
          <div className="lg:col-span-7 flex flex-col gap-6">
            <div className="enterprise-badge mb-2">
              <Layers className="w-3.5 h-3.5 text-[#0F6B82]" />
            ...
            <div className="flex gap-4 items-center">
              ...
              <p className="text-xs text-[#0F6B82] uppercase tracking-wider font-semibold">
                Focused on Actionable Playbooks &amp; Real Bottom-Line Results
              </p>
            </div>
          </div>
          <div className="lg:col-span-5 w-full aspect-video sm:aspect-square rounded-3xl bg-[#F7F9FA] border border-[#E5EBEF] flex items-center justify-center relative overflow-hidden shadow-card">
            <div className="icon-teal w-20 h-20">
              <Layers className="w-10 h-10 text-[#0F6B82]" />
            </div>
          </div>
        </div>
        ...
        <div className="enterprise-card p-8 sm:p-12 text-center max-w-3xl mx-auto bg-gradient-to-br from-[#F7F9FA] to-white border border-[#E5EBEF]">
          <h3 className="text-2xl font-bold font-display text-[#1B2730] mb-3">Optimize Your Strategic Direction</h3>
          <p className="text-[#6C7A86] text-sm sm:text-base leading-relaxed mb-6">
            Review your operational models, market-entry objectives, or organizational structures with our senior consulting partners.
          </p>
          <Link href="/contact">
